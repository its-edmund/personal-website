...
const Technologies: Technology[] = [
  ...
  {
    title: "Tailwind CSS",
    description: "CSS styling library",
    backgroundColor: "bg-blue-600",
    image: TailwindLogo,
  },
  {
    title: <h3 className="text-3xl font-thin font-['Helvetica']">Express</h3>,
    description: "Lightweight backend library",
        ...
        <div className="flex flex-col gap-12 md:w-3/4 mx-auto w-full">
          ...
          <Fade duration={1500}>
            <ExperienceCard className="bg-gradient-to-l from-rose-300 to-rose-400">
              ...
              <div className="z-10 relative w-full">
                <p className="text-lg">
                  I was a full stack intern for Tesla&#39;s Supply Chain
                  Automation team. I worked on an application that helps Global
                  Supply Managers analyze part prices which can help provide
                  information for price negotiation. These tools help to reduce
          ...
          <Fade duration={1500}>
            <ExperienceCard className="bg-gradient-to-r from-orange-400 via-violet-500 to-blue-500">
              <div className="w-full md:w-1/4 z-10 relative mr-8">
              ...
              <div className="w-full">
                <p className="text-lg">
                  Streamr Network is a decentralized pub/sub network built on
                  the Ethereum cryptocurrency. The network is made up of
                  thousands of operator nodes which provide computing power and
                  a path for real-time data to travel. As an intern, I was
                  tasked to create a chat application that would utilize the
                  Streamr Network to demostrate potential use cases.
                </p>
              </div>
            </ExperienceCard>
          </Fade>
                  ...
                  <div className="w-4/5 mt-6 mx-auto">
                    <div className="flex">
                      <div className="flex flex-col items-center mr-4">
                        <div className="w-px h-24 bg-gradient-to-t from-fuchsia-500 to-neutral-900 ml-[11px]">
                        </div>
                      </div>
                    </div>
                    <div className="flex">
                      <div className="flex flex-col items-center mr-4">
                        <div>
                          <div className="flex items-center justify-center w-6 h-6 bg-fuchsia-500 rounded-full">
                          </div>
                        </div>
                        <div className="w-px h-full bg-gradient-to-b from-fuchsia-500 to-purple-500">
                        </div>
                      </div>
                      <div className="pb-8 ">
                    ...
                    <div className="flex">
                      <div className="flex flex-col items-center mr-4">
                        ...
                        <div className="w-px h-full bg-gradient-to-b from-purple-500 to-violet-700">
                        </div>
                      </div>
                      <div className="pb-8 ">
                        <h4 className="text-xs font-medium text-neutral-300">
                    ...
                    <div className="flex">
                      <div className="flex flex-col items-center mr-4">
                        <div>
                          <div className="flex items-center justify-center w-6 h-6 bg-violet-700 rounded-full">
                          </div>
                        </div>
                        <div className="w-px h-full bg-gradient-to-b from-violet-700 to-neutral-900">
                        </div>
                      </div>
                      <div className="pb-8">
                        <h4 className="text-xs font-medium text-neutral-300">
              ...
              <div className="bg-gradient-to-bl from-red-600 to-orange-500 w-full rounded-2xl p-1 max-h-fit">
                <div className="bg-neutral-900 w-full h-full rounded-xl md:px-20 px-8 py-8 md:py-14">
                  ...
                  <div className="w-4/5 mt-6 mx-auto">
                    <div className="flex">
                      <div className="flex flex-col items-center mr-4">
                        <div className="w-px h-24 bg-gradient-to-t from-red-500 to-neutral-900 ml-[11px]">
                        </div>
                      </div>
                    </div>
                    <div className="flex">
                      <div className="flex flex-col items-center mr-4">
                        ...
                        <div className="w-px h-full bg-gradient-to-b from-red-500 to-orange-600">
                        </div>
                      </div>
                      <div className="pb-8 ">
                        <h4 className="text-xs font-medium text-neutral-300">
                    ...
                    <div className="flex">
                      <div className="flex flex-col items-center mr-4">
                        <div>
                          <div className="flex items-center justify-center w-6 h-6 bg-orange-600 rounded-full">
                          </div>
                        </div>
                        <div className="w-px h-full bg-gradient-to-b from-orange-600 to-amber-600">
                        </div>
                      </div>
                      <div className="pb-8 ">
                        <h4 className="text-xs font-medium text-neutral-300">
                    ...
                    <div className="flex">
                      <div className="flex flex-col items-center mr-4">
                        <div>
                          <div className="flex items-center justify-center w-6 h-6 bg-amber-600 rounded-full">
                          </div>
                        </div>
                        <div className="w-px h-full bg-gradient-to-b from-amber-600 to-yellow-600">
                        </div>
                      </div>
                      <div className="pb-8">
                        <h4 className="text-xs font-medium text-neutral-300">
                    ...
                    <div className="flex">
                      <div className="flex flex-col items-center mr-4">
                        <div>
                          <div className="flex items-center justify-center w-6 h-6 bg-yellow-600 rounded-full">
                          </div>
                        </div>
                        <div className="w-px h-full bg-gradient-to-b from-yellow-600 to-neutral-900">
                        </div>
                      </div>
                      <div className="pb-8">
                        <h4 className="text-xs font-medium text-neutral-300">
