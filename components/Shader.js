...
uniform float iTime;
vec2 iResolution = vec2(10000000.0);   //<---------- Kinda the graininess/rng seed PLAY WITH THIS
...
void main() {
    ...
    #endif
    #endif
    gl_FragColor = vec4(1.,1.,100.,color.r);     //<---------- Kinda like tint PLAY WITH THIS
}
`;
